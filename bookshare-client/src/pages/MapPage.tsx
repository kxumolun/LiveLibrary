              ...
              >
                ...
                <div className="space-y-2">
                  {owner.books.map((book) => (
                    ...
                    >
                      {book.coverUrl ? (
                        <img src={book.coverUrl} className="w-8 h-10 object-cover rounded" alt={book.title} />
                      ) : (
                        <div className="w-8 h-10 bg-gray-200 rounded flex items-center justify-center text-xs">📚</div>
                      )}
              ...
              <div className="space-y-3">
                {selectedOwner.books.map((book) => (
                  <div key={book.id} className="flex items-center gap-3 p-3 border rounded-xl">
                    ...
                    >
                      {book.coverUrl ? (
                        <img src={book.coverUrl} className="w-12 h-16 object-cover rounded" alt={book.title} />
                      ) : (
                        <div className="w-12 h-16 bg-gray-200 rounded flex items-center justify-center text-xl">📚</div>
                      )}
                    </div>
                    <div
