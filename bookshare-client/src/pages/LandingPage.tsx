  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-white">
      ...
      <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2d5986] text-white py-16 sm:py-24">
        <div className="container-app text-center">
          ...
          <p className="text-base sm:text-lg text-blue-100/90 max-w-2xl mx-auto mb-8 sm:mb-10">
            Uyingizda changyutayotgan kitoblarni boshqalarga bering,
            o'qimoqchi bo'lgan kitoblarni atrofingizdagi odamlardan ijaraga oling.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <div key={item.step} className="text-center">
                ...
                <span className="text-yellow-500 font-bold text-sm">{item.step}</span>
                <h3 className="text-xl font-bold text-[#1e3a5f] mt-1 mb-2">{item.title}</h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm ring-1 ring-slate-200/60">
              ...
              <ol className="space-y-2 text-sm text-slate-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <span className="font-semibold">Kitobni tanlang</span> va “Ijaraga olish”ni bosing.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="font-bold text-primary-700">2.</span>
                  <span>
                    Egasi ko‘radi va javob beradi. Qabul bo‘lsa, xabar orqali gaplashasiz.
                  </span>
                </li>
                <li className="flex gap-2">
                ...
                <li className="flex gap-2">
                  ...
                  <span>
                    Muddat tugagach, kitobni qaytarasiz.
                  </span>
                </li>
              </ol>
            ...
            <div className="bg-slate-50 rounded-2xl p-6 ring-1 ring-slate-200/60">
              ...
              <ul className="space-y-2 text-sm text-slate-700">
                <li className="flex gap-2">
                  ...
                  <span>
                    <span className="font-semibold">Radius</span>ni (100m–5km) o‘zgartirib, yaqin kitoblarni tez toping.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary-700 font-bold">•</span>
                  <span>
                    Pin ustiga bosing — egasi va <span className="font-semibold">mavjud</span> kitoblar ro‘yxati chiqadi.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary-700 font-bold">•</span>
                  <span>
                    Joylashuvni yoqmasangiz ham ishlaydi: xarita baribir ochiladi (masalan, Toshkent).
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary-700 font-bold">•</span>
                  <span>
                    “Kitoblarni ko‘rish”ni bosib, o‘sha odamdagi kitoblarni bir joyda ko‘ring.
                  </span>
                </li>
              </ul>
            </div>
      ...
      <section className="bg-[#f8fafc] py-14 sm:py-20">
        <div className="container-app">
          <h2 className="text-3xl font-extrabold text-center text-[#1e3a5f] mb-12">
            Nima uchun LiveLibrary?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              { icon: '🗺️', title: 'Xaritadan topish', desc: 'Yaqin atrofdagi kitob egalari va mavjud kitoblarni pinlar orqali ko‘ring.' },
              { icon: '💬', title: 'Xabar orqali kelishish', desc: 'So‘rovdan keyin yozishma ochiladi — uchrashuv va vaqtni kelishib olasiz.' },
              { icon: '📌', title: 'Holat aniq', desc: '“Mavjud” yoki “Ijarada” degan holatni ko‘rib, bekorga vaqt ketmaydi.' },
              { icon: '⚡', title: 'Tezkor so‘rov', desc: 'Bir necha bosishda ijara so‘rovini yuboring va javob oling.' },
            ].map((f) => (
              <div key={f.title} className="flex gap-4 bg-white rounded-xl p-6 shadow-sm">
                <span className="text-3xl">{f.icon}</span>
                <div>
                  <h3 className="font-bold text-[#1e3a5f] text-lg">{f.title}</h3>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={x.title} className="bg-white rounded-2xl p-6 shadow-sm ring-1 ring-slate-200/60">
      ...
      <section className="bg-gradient-to-br from-[#1e3a5f] to-[#2d5986] text-white py-14 sm:py-20 text-center">
        <div className="container-app">
        <h2 className="text-3xl sm:text-4xl font-extrabold mb-3">Bugun boshlang!</h2>
      ...
      <footer className="text-center py-8 text-gray-400 text-sm">
        © 2026 LiveLibrary — Barcha huquqlar himoyalangan
      </footer>
    </div>
  );
}